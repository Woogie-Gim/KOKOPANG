    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                .cors((corsCustomizer -> corsCustomizer.configurationSource(new CorsConfigurationSource() {
                    ...
                    public CorsConfiguration getCorsConfiguration(HttpServletRequest request) {
                        ...
                        List<String> allowedOrigins = Arrays.asList("http://j10c211.p.ssafy.io", "https://j10c211.p.ssafy.io","http://localhost:3000");
        ...
        http
                .authorizeHttpRequests((auth) -> auth
                        .requestMatchers("/login", "/", "/user/signup","/profile/read/**","/profile/getImg/**"
                                ,"/item/create","/rank/all","/board/all", "/board/read","/user/nameread").permitAll()
