...
const LoginForm = () => {
  ...
  const { isLogin, login, PATH, token, setToken, setTokenExpireTime, logout } = useAuthStore(
    useShallow((state) => ({
  ...
  const { setUser, name, setProfileImage } = useUserStore(
    useShallow((state) => ({
      ...
      {isLogin ? (
        <LoginBox>
          <UserBox>
            <div className="img_box">
              ...
              {!deung ? (
                <div className="btn" onClick={profileUpload} style={{ fontSize: "20px", color: "blue" }}>
                  등록
                </div>
              ) : (
                <div
            ...
            <div style={{ padding: "10px" }}>
              {user.friendsList.map((friend, idx) => (
                ...
                >
                  ...
                  <div className="item1">
                    <img
                      src={friend.friendProfileImg === null ? defaultProfile : friend.friendProfileImg}
                      alt="친구 프로필 이미지"
        ...
        <LoginBox>
          ...
          <img
            src={subImg}
            alt="심심이미지"
            style={{ width: "200px", height: "200px", margin: "0 auto", marginTop: "30px" }}
          />
        </LoginBox>
      )}
    </>
